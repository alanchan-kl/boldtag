...
if(WebUI.waitForElementVisible(findTestObject('Client Portal/a.Common/button_End tour'), 3)){
	WebUI.click(findTestObject('Client Portal/a.Common/button_End tour'))
}

if(WebUI.waitForElementVisible(findTestObject('Client Portal/a.Common/sidebar_username'), 3)){
